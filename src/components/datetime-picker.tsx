...
type DateTimePickerProps = {
  ...
  /**
   * Container element for the popover portal. Useful when rendering inside sheets/dialogs.
   **/
...
const DateTimePicker = React.forwardRef<Partial<DateTimePickerRef>, DateTimePickerProps>(
  (
    ...
    /**
     * Makes sure display date and calendar month update when value changes on
     * parent component (e.g., from preset buttons)
     */
    React.useEffect(() => {
